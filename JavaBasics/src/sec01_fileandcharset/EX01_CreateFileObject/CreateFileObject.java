...
public class CreateFileObject {
	public static void main(String[] args) throws IOException {
		...
		System.out.println(newFile5.getAbsolutePath()); //C:\abc\newFile.txt
		System.out.println(newFile6.getAbsolutePath()); //C:\abc\bcd\newFile.txt
		
		// 3-2. 상대경로
		//현재위치
		System.out.println(System.getProperty("user.dir")); //현재작업폴더 위치 C:\dev\workspace\JavaBasics
		File newFile7 = new File("newFile1.txt");
		File newFile8 = new File("bcd/newFile2.txt");
		System.out.println(newFile7.getAbsolutePath()); //C:\dev\workspace\JavaBasics\newFile1.txt
		System.out.println(newFile8.getAbsolutePath()); //C:\dev\workspace\JavaBasics\bcd\newFile2.txt
