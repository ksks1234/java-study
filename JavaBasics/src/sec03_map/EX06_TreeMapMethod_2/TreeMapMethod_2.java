...
public class TreeMapMethod_2 {
	public static void main(String[] args) {
		...
		// 3. MyClass 객체 크기 비교
		/*
		 * TreeMap<MyClass, String> treeMap3 = new TreeMap<MyClass, String>(); MyClass
		 * myClass1 = new MyClass(2, 5); MyClass myClass2 = new MyClass(3, 3);
		 * treeMap3.put(myClass1, "가나다"); treeMap3.put(myClass2, "나라다");
